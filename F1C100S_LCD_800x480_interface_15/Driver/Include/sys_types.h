...
//add by qlqcect
#define u8  unsigned char          ///< Define 8-bit register data type
#define u16 unsigned short        ///< Define 16-bit register data type
#define u32 unsigned int          ///< Define 32-bit register data type

#define s8 char          ///< Define 8-bit register data type
#define s16 short      ///< Define 16-bit register data type
#define s32 int          ///< Define 32-bit register data type
//end add
