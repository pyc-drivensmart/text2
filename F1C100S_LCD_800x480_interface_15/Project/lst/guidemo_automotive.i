#line 1 "..\\USR\\GUIDemo\\GUIDEMO_Automotive.c"
...
#line 35 "..\\USR\\GUIDemo\\GUIDEMO_Automotive.c"
...
#line 54 "..\\USR\\GUIDemo\\GUIDEMO_Automotive.c"
...
static const GUI_COLOR _ColorsScaleR140[] = {
...
static const GUI_LOGPALETTE _PalScaleR140 = {
  29, 
  0,  
  &_ColorsScaleR140[0]
};

static const unsigned char _acScaleR140[] = {
...
static const GUI_BITMAP _bmScaleR140 = {
  200,           
  73,            
  200,           
  8,             
...
static NEEDLE _aNeedle[2] = {
  { _aNeedle_0, (sizeof(_aNeedle_0) / sizeof(_aNeedle_0[0])) },
  { _aNeedle_1, (sizeof(_aNeedle_1) / sizeof(_aNeedle_1[0])) }
};
...
static void _DrawBk(int Logo) {
  ...
  if (_ShowMSec) {
    ...
    GUI_DispDecAt(0, 10, ySize - 40 + 17, 3);
  }
  ...
  if (_ShowGear) {
    ...
    GUI_DispStringHCenterAt("Gear    1", xSize / 2, (ySize - GUI_GetFontDistY()) / 2);
  }
}
...
static void _WriteGear(int Gear) {
  ...
  if (_ShowGear) {
    if (_OldGear != Gear) {
      ...
      GUI_SetTextMode((0));
      GUI_SetFont(&GUI_FontRounded22);
      GUI_DispDecAt(Gear, ((xSize + GUI_GetStringDistX("Gear    1") + 1) / 2) - GUI_GetCharDistX('1'), (ySize - GUI_GetFontDistY()) / 2, 1);
    }
  }
}
...
static float (* _pfGetAngle[2])(int tDiff) = {
  _GetAngle_0,
  _GetAngle_1
};
...
static void _Draw_0(void * p) {
  ...
  if (pParam->AutoDevInfo.DrawFixed) {
    GUI_ClearRect ((xSize - _bmScaleR140.XSize) / 2, _ySpace + _bmScaleR140.YSize, ((xSize - _bmScaleR140.XSize) / 2) + _bmScaleR140.XSize - 1, _ySpace + 98);
  ...
  GUI_SetColor(0x00FFFFFF);
  GUI_AA_FillPolygon(pParam->aPoints, (sizeof(_aNeedle_0) / sizeof(_aNeedle_0[0])), 3 * (xSize / 2), 3 * (_ySpace + 98 + 40));
...
static void _Draw_1(void * p) {
  ...
  if (pParam->AutoDevInfo.DrawFixed) {
    GUI_ClearRect ((xSize - _bmScaleR140.XSize) / 2, 2 * (_ySpace + _bmScaleR140.YSize), ((xSize - _bmScaleR140.XSize) / 2) + _bmScaleR140.XSize - 1, 2 * (_ySpace + 98));
    GUI_DrawBitmap(&_bmScaleR140, (xSize - _bmScaleR140.XSize) / 2, (2 * _ySpace) + 98);
  }
  
  
  
  GUI_SetColor(0x00FFFFFF);
  GUI_AA_FillPolygon(pParam->aPoints, (sizeof(_aNeedle_1) / sizeof(_aNeedle_1[0])), 3 * (xSize / 2), 3 * ((2 * (_ySpace + 98)) + 40));
  ...
  if (pParam->AutoDevInfo.DrawFixed) {
    ...
    GUI_SetColor(0x000000FF);
    GUI_SetFont(&GUI_FontRounded22);
    GUI_DispStringHCenterAt("MPH / 10", xSize / 2, (2 * _ySpace) + 98 + _bmScaleR140.YSize + 5);
  }
}
...
static void _AutomotiveDemo(void) {
  ...
  for (i = 0; i < 2; i++) {
    ...
    aParam[i].Angle = _pfGetAngle[i](tDiff) * (3.1415926f / 180);
  ...
  for (Cnt = 0; ((tDiff = GUIDEMO_GetTime() - t0) < 15000) && !GUIDEMO_CheckCancel(); Cnt++) {
    ...
    if (_ShowMSec) {
      if (!(Cnt % 20)) {
        ...
        GUI_SetFont(&GUI_FontRounded16);
        for (i = 0; i < 2; i++) {
          GUI_ClearRect(10, ySize - 40 + 17, ySize / 2, ySize - 40 + 17 + GUI_FontRounded16.YSize);
          GUI_DispDecAt(atDiff[i], 10, ySize - 40 + 17, 3);
        }
      }
    }
    GUI_Exec();
...
void GUIDEMO_Automotive(void) {
  ...
  GUIDEMO_ConfigureDemo("Automotive", "Sample for the automotive industry", (1 << 0) | (1 << 2));
  DrawLogo = 0;
  xSize    = LCD_GetXSize();
  ySize    = LCD_GetYSize();
  _ySpace  = (ySize - (2 * 98)) / (2 + 1); 
  
  
  
  if (((bmSeggerLogo70x35.XSize + 5) < ((xSize - _bmScaleR140.XSize) / 2)) || ((bmSeggerLogo70x35.YSize + 5) < _ySpace)) {
    DrawLogo = 1;
  }
  if ((GUI_GetStringDistX("msec/picture:\n") < ((xSize - _bmScaleR140.XSize) / 2)) || ((2 * (_ySpace + 98)) < (ySize - 40))) {
    _ShowMSec = 1;
  }
  pFontOld = GUI_SetFont(&GUI_FontRounded22);
...
#line 1042 "..\\USR\\GUIDemo\\GUIDEMO_Automotive.c"
