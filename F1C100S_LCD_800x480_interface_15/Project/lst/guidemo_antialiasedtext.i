#line 1 "..\\USR\\GUIDemo\\GUIDEMO_AntialiasedText.c"
...
#line 35 "..\\USR\\GUIDemo\\GUIDEMO_AntialiasedText.c"
...
static void _DrawAlphaCircles(int mx, int my, int r, int a, int FactorAA) {
  ...
  for (i = 0, Index = 0; i < 360000; i += 22500, Index++) {
    ...
    x     = ((r * CosHQ) / 65536);
    y     = ((r * SinHQ) / 65536);
    GUI_SetColor(aColor[Index % (int)(sizeof(aColor) / sizeof(aColor[0]))]);
...
static void _DrawSample(GUI_RECT Rect, const GUI_FONT * pFont, const char * pText) {
  ...
  GUI_DispStringInRectWrap(pText, &CurrentRect, (2<<0) | (3<<2), GUI_WRAPMODE_WORD);
  ...
  GUI_DispStringInRect("ABC", &CurrentRect, (2<<0) | (3<<2));
  ...
  CurrentRect.y1 = Rect.y0 + 3 * yDistDiv3;
  GUI_MoveRect(&CurrentRect, 63, 0);
  GUI_DrawGradientH(CurrentRect.x0, CurrentRect.y0, CurrentRect.x1, CurrentRect.y1, 0x00000000, 0x00FFFFFF);
  CurrentRect.y1 = CurrentRect.y0 + yDistDiv3;
  ...
  CurrentRect.y1 = CurrentRect.y0 + yDistDiv3;
  GUI_MoveRect(&CurrentRect, 63, 0);
  GUI_DrawGradientV(CurrentRect.x0, CurrentRect.y0, CurrentRect.x1, CurrentRect.y1, 0x000000FF,   0x00000000);
  GUI_MoveRect(&CurrentRect, 0, yDistDiv3);
  GUI_DrawGradientV(CurrentRect.x0, CurrentRect.y0, CurrentRect.x1, CurrentRect.y1, 0x0000FF00, 0x00000000);
  GUI_MoveRect(&CurrentRect, 0, yDistDiv3);
  GUI_DrawGradientV(CurrentRect.x0, CurrentRect.y0, CurrentRect.x1, CurrentRect.y1, 0x00FF0000,  0x00000000);
  CurrentRect.y0 = Rect.y0;
  CurrentRect.y1 = CurrentRect.y0 + yDistDiv3;
  GUI_SetColor(0x00FFFFFF);
  GUI_DispStringInRect("ABC", &CurrentRect, (2<<0) | (3<<2));
...
#line 268 "..\\USR\\GUIDemo\\GUIDEMO_AntialiasedText.c"
